          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <button className="bg-black bg-opacity-70 text-white px-8 py-3 rounded-full hover:bg-opacity-90 transition-all font-medium text-lg">
                  Learn more...
                </button>
                <button className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full hover:bg-white hover:text-blue-600 transition-all font-medium text-lg">
                  Sign Up
                </button>
              </div>
            </div>
